...
class _AddAboutYouState extends State<AddAboutYou> {
  ...
  // void getUsers() {
  //   // userAPI.getCurUsers().then((value) {
  //   workExperienceList = widget.user.workExperience ?? [];
  ...
  Widget build(BuildContext context) {
    return Consumer<UserAPI>(builder: (context, userApi, _) {
      return FutureBuilder<Users?>(
          future: userApi.getCurUsers(),
