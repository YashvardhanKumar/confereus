...
//     socket.emit('users', [accessToken, refreshToken, {}]);
...
//   }
//
//   void getUsersOneLive(
//       StreamController<Users?> controller, String userId) async {
//     String? refreshToken = await secstore.read(key: 'login_refresh_token');
//     String? accessToken = await secstore.read(key: 'login_access_token');
//     socket.emit('users', [
//       accessToken,
...
//         await client.getUrl(Uri.parse(getAllUsersRoute));
